...
import static MainFiles.IndexPage.materialRequisitionNote;
 ...
 * @author Ravindu
 */
public class MaterialRequisitionNote extends javax.swing.JInternalFrame {
    ...
    public MaterialRequisitionNote() {
        ...
        model_DisposalItemTable = (DefaultTableModel) tableMRNItem.getModel();
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Material Requisition Note");
        ...
        tableMRNItem.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Code", "Name", "Unit", "Purchase price", "MRN Qunatity", "Amount", "Supplier"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class
    ...
    private void SaveAsMRN(String Time, String Date) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Material Requisition Note is successfully saved.");
            buttonSave.setEnabled(false);
    ...
    private void CheckAtUpdateButtonBeforeUpdate() {
        if (!TextPurchasePrice.getText().equals("") && !TextQuantity.getText().equals("") && !TextAmount.getText().equals("")) {
            ...
            try {
                ...
                Logger.getLogger(MaterialRequisitionNote.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//        float Amount = Float.parseFloat(TextAmount.getText().toString());
    ...
    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        materialRequisitionNote.toFront();
