...
import static MainFiles.IndexPage.purchaseRequisitionNote;
...
public class PurchaseRequisitionNote extends javax.swing.JInternalFrame {
    ...
    public PurchaseRequisitionNote() {
        ...
        model_DisposalItemTable = (DefaultTableModel) tablePRNItem.getModel();
    ...
    private void initComponents() {
        ...
        tablePRNItem = new javax.swing.JTable();
        ...
        txtPRNID = new javax.swing.JTextField();
        ...
        setIconifiable(true);
        setTitle("Purchase Requisition Note");
        ...
        PanelGRN.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(153, 153, 153), 1, true), "Purchase requisition note items"));

        tablePRNItem.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Code", "Name", "Unit", "Purchase price", "PRN Qunatity", "Amount", "Supplier"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class
        ...
        tablePRNItem.getTableHeader().setReorderingAllowed(false);
        tablePRNItem.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablePRNItemMouseClicked(evt);
            }
        });
        tablePRNItem.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tablePRNItemKeyPressed(evt);
            }
        });
        jScrollPane3.setViewportView(tablePRNItem);
        if (tablePRNItem.getColumnModel().getColumnCount() > 0) {
            tablePRNItem.getColumnModel().getColumn(1).setPreferredWidth(250);
        }
        ...
        txtPRNID.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txtPRNID.setEnabled(false);
        panel1.add(txtPRNID, new org.netbeans.lib.awtextra.AbsoluteConstraints(569, 610, 110, -1));

        lbl_category8.setForeground(new java.awt.Color(102, 102, 102));
        lbl_category8.setText(" Requset from (Department)");
        panel1.add(lbl_category8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 140, 20));
        ...
        panel1.add(cmbTakeFromDepartment, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 60, 310, -1));
    ...
    private void LoadRequestFromToCombo() {
        try {
            ...
            String query = "select * From Departments order by DepartmentName";  //where Type != 'Stock' 
    ...
    private void CheckBeforeSave() {
        int TransferRowCount = tablePRNItem.getRowCount();
        ...
        if (textDate.getText().equals("")) {
            ...
            if (OtherChargers < 0) {
                ...
                int x = JOptionPane.showConfirmDialog(this, "Are you sure to save this Purchase Requisition Note?", "Save Purchase Requisition Note?", JOptionPane.YES_NO_OPTION);
    ...
    private void SaveAsPRN(String Time, String Date) {
        ...
        try {
            ...
            for (int i = 0; i < RowCount; i++) {
                ItemCode = tablePRNItem.getValueAt(i, 0).toString();
                ItemName = tablePRNItem.getValueAt(i, 1).toString();
                PurchaseUnitCode = tablePRNItem.getValueAt(i, 2).toString();
                PurchasePrice = roundTwoDecimals(Double.parseDouble(tablePRNItem.getValueAt(i, 3).toString()));
                Quantity = roundThreeDecimals(Double.parseDouble(tablePRNItem.getValueAt(i, 4).toString()));
                Amount = roundTwoDecimals(Double.parseDouble(tablePRNItem.getValueAt(i, 5).toString()));

                String ItemInsertQuery = "INSERT INTO [PRNItems]\n"
                        + "           ([PRNID]\n"
                        + "           ,[ItemCode]\n"
                        + "           ,[ItemName]\n"
                        + "           ,[UnitPurchase]\n"
            ...
            JOptionPane.showMessageDialog(this, "Purchase Requisition Note is successfully saved.");
            buttonSave.setEnabled(false);
    ...
    private void Refresh() {
        int x = JOptionPane.showConfirmDialog(this, "Refresh Purchase Requisition Note window?", "Refresh", JOptionPane.YES_NO_OPTION);
        if (x == JOptionPane.YES_OPTION) {
            rBtnCode.setSelected(true);
            LoadSystemDate();
            LoadTaxesToLables();
    ...
    private void exit() {
        int rowCount = tablePRNItem.getRowCount();
        String ID = txtPRNID.getText();
        if (rowCount > 0 && ID.isEmpty()) {
            int x = JOptionPane.showConfirmDialog(this, "Are you sure to exit without saving this Purchase Requisition Note?", "Exit Purchase Requisition Note?", JOptionPane.YES_NO_OPTION);
            if (x == JOptionPane.YES_OPTION) {
                if (purchaseRequisitionNote != null) {
                    purchaseRequisitionNote = null;
                }
                this.dispose();
            }
    ...
    private void SaveForTestPreview(String Time, String Date) {
        ...
        try {
            ...
            for (int i = 0; i < rowCount; i++) {
                ...
                Quantity = roundThreeDecimals(Double.parseDouble(tablePRNItem.getValueAt(i, 4).toString()));
                Amount = roundTwoDecimals(Double.parseDouble(tablePRNItem.getValueAt(i, 5).toString()));
                ExpireDate = tablePRNItem.getValueAt(i, 6).toString();
    ...
    private void Preview() {
        ...
        try {
            ...
            String Report = "PRN ID wise single report.jrxml";
            JasperDesign jasperdesigns = JRXmlLoader.load(projectPath + "/Reports/Transaction Reports Request/PR/" + Report);
            JasperReport jasperreport = JasperCompileManager.compileReport(jasperdesigns);
            JasperPrint jasperprint = JasperFillManager.fillReport(jasperreport, map, sqlcon);
            JasperViewer.viewReport(jasperprint, false);
        } catch (JRException ex) {
    ...
    private void TableAvailableItemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableAvailableItemMouseClicked
        ...
        tablePRNItem.setSelectionMode(0);
    ...
    private void tablePRNItemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablePRNItemMouseClicked
        if (evt.getClickCount() == 1) {
            TableAvailableItem.setSelectionMode(0);
            buttonSave.setEnabled(false);
            String PurchasePrice, Quantity, Amount;
            float CheckAmount = Float.parseFloat(tablePRNItem.getValueAt(tablePRNItem.getSelectedRow(), 5).toString());
            if (CheckAmount > 0) {
                PurchasePrice = tablePRNItem.getValueAt(tablePRNItem.getSelectedRow(), 3).toString();
                Quantity = tablePRNItem.getValueAt(tablePRNItem.getSelectedRow(), 4).toString();
                Amount = tablePRNItem.getValueAt(tablePRNItem.getSelectedRow(), 5).toString();
                TextPurchasePrice.setText(PurchasePrice);
                TextQuantity.setText(Quantity);
            ...
            if (x == JOptionPane.YES_OPTION) {
                int i = tablePRNItem.getSelectedRow();
    ...
    }//GEN-LAST:event_tablePRNItemMouseClicked

    private void tablePRNItemKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tablePRNItemKeyPressed
    ...
    }//GEN-LAST:event_tablePRNItemKeyPressed

    private void CalculateAmountWithOutTax() {

        float ItemPriceAmount;
        float TotalWithoutTaxes = 0;
        int GRNTableRowCount = tablePRNItem.getRowCount();
        for (int i = 0; i < GRNTableRowCount; i++) {
            ItemPriceAmount = Float.parseFloat(tablePRNItem.getValueAt(i, 5).toString());
    ...
    private void ButtonAddSelectedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonAddSelectedActionPerformed
        ...
        int SelectedRowCountAtMRN = tablePRNItem.getSelectedRowCount();
    ...
    private void CheckBeforeAddToTransferTable() {
        float totalQuantityWithAvailable, MaximumQty, maxQuantityToRequest, AvailableQuantity;
        int SelectedRow = TableAvailableItem.getSelectedRow();
        try {            
            float insertedQuantity = Float.parseFloat(TextQuantity.getText());
            String ItemCode = TableAvailableItem.getValueAt(SelectedRow, 0).toString();
            String ItemName = TableAvailableItem.getValueAt(SelectedRow, 1).toString();
            ...
            String ItemQuery = "SELECT MaximumQty, Quantity FROM Items WHERE ItemCode='" + ItemCode + "'";
            RSETAvaItems = stmtGRNItems.executeQuery(ItemQuery);
            if (RSETAvaItems.next()) {
                AvailableQuantity = RSETAvaItems.getFloat("Quantity");
                MaximumQty = RSETAvaItems.getFloat("MaximumQty");
                totalQuantityWithAvailable = AvailableQuantity + insertedQuantity;
                maxQuantityToRequest = MaximumQty - AvailableQuantity;

//                if (AvailableQuantity > 0 && AvailableQuantity >= insertedQuantity) {
//                    AddToTransferTable();a
//                } else if (AvailableQuantity <= 0) {
//                    JOptionPane.showMessageDialog(this, "Quantity is not enough to request.", "Not enough.", JOptionPane.OK_OPTION);
//                } else if (AvailableQuantity < insertedQuantity) {
//                    JOptionPane.showMessageDialog(this, "PRN quantity should be less than the available quantity.", "Not enough.", JOptionPane.OK_OPTION);
//                }
                if (MaximumQty >= totalQuantityWithAvailable) {
                    AddToTransferTable();
                } else if (insertedQuantity <= 0) {
                    JOptionPane.showMessageDialog(this, "Quantity is not enough to request.", "Not enough.", JOptionPane.OK_OPTION);
                    TextQuantity.requestFocus();
                } else if (MaximumQty < totalQuantityWithAvailable) {
                    JOptionPane.showMessageDialog(this, "Requesting quantity should be less than the maximum quantity.\nMaximum quantity for request '" + ItemName + "' is '" + maxQuantityToRequest + "'.", "Maximum quantity is exceeded.", JOptionPane.OK_OPTION);
                    TextQuantity.requestFocus();
                }
            }
            ...
            Logger.getLogger(PurchaseRequisitionNote.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(this, ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            JOptionPane.showMessageDialog(this, "Please contact for support.");
        }
    }
    ...
    private void FirstCheckBeforeAddToTransferTableWithTransactionQuantity() {
        buttonSave.setEnabled(false);
        int SelectedRowCount = tablePRNItem.getSelectedRowCount();
        if (SelectedRowCount == 1) {
            if (!TextPurchasePrice.getText().equals("") && !TextQuantity.getText().equals("") && !TextAmount.getText().equals("")) {
    ...
    private void CheckAtUpdateButtonBeforeUpdate() {
        if (!TextPurchasePrice.getText().equals("") && !TextQuantity.getText().equals("") && !TextAmount.getText().equals("")) {
            ...
            float AvailableQuantity, totalQuantityWithAvailable, MaximumQty, maxQuantityToRequest;
            int getSelectedRowAtTransactionTable = tablePRNItem.getSelectedRow();
            try {
                ItemCode = tablePRNItem.getValueAt(getSelectedRowAtTransactionTable, 0).toString();
                ItemName = tablePRNItem.getValueAt(getSelectedRowAtTransactionTable, 1).toString();
                ResultSet RSETAvaItems;
                java.sql.Statement stmtItems = ConnectSql.conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
                String ItemQuery = "SELECT MaximumQty, Quantity FROM Items WHERE ItemCode='" + ItemCode + "'";
    ...
    private void UpdateToReturnTable() {
        int SelectedRow = tablePRNItem.getSelectedRow();
...
//        float Amount = Float.parseFloat(TextAmount.getText().toString());
        ...
        tablePRNItem.setValueAt(PurchasePrice, SelectedRow, 3);
        tablePRNItem.setValueAt(Quantity, SelectedRow, 4);
        tablePRNItem.setValueAt(Amount, SelectedRow, 5);
        CalculateAmountWithOutTax();
    }
    ...
    private void CheckAtQuantityFieldBeforeUpdateWithAvailableQuantity() {
        if (!TextPurchasePrice.getText().equals("") && !TextQuantity.getText().equals("") && !TextAmount.getText().equals("")) {
            float Amount, AvailableQuantity, totalQuantityWithAvailable, MaximumQty, maxQuantityToRequest;
            int SelectedRow = TableAvailableItem.getSelectedRow();
            ...
            if (insertedQuantity > 0) {
                try {
                    ...
                    if (RSETAvaItems.next()) {
                        ...
                        maxQuantityToRequest = MaximumQty - AvailableQuantity;
                        if (MaximumQty >= totalQuantityWithAvailable) {
                            Amount = PurchasePrice * insertedQuantity;
    ...
    private void CheckAtQuantityFieldBeforeUpdateWithTransactionQuantity() {
        if (!TextPurchasePrice.getText().equals("") && !TextQuantity.getText().equals("") && !TextAmount.getText().equals("")) {
            ...
            if (insertedQuantity > 0) {
                try {
                    String ItemCode = tablePRNItem.getValueAt(SelectedRow, 0).toString();
                    String ItemName = tablePRNItem.getValueAt(SelectedRow, 1).toString();
                    ResultSet RSETAvaItems;
                    java.sql.Statement stmtGRNItems = ConnectSql.conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
                    String ItemQuery = "SELECT MaximumQty, Quantity FROM Items WHERE ItemCode='" + ItemCode + "'";
                    RSETAvaItems = stmtGRNItems.executeQuery(ItemQuery);
    ...
    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        purchaseRequisitionNote.toFront();
    ...
    private void buttonWriteNotesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonWriteNotesActionPerformed
        ...
        if (!TransactionID.equals("")) {
            ...
            JOptionPane.showMessageDialog(this, "Please save the Purchase Requisition Note. After that you can write your notes.", "Save first", JOptionPane.OK_OPTION);
        }
    ...
    public static javax.swing.JTable tablePRNItem;
    ...
    public static javax.swing.JTextField txtPRNID;
