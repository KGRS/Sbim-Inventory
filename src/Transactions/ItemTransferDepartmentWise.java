...
import static MainFiles.IndexPage.ITDW;
 ...
 * @author Ravindu
 */
public class ItemTransferDepartmentWise extends javax.swing.JInternalFrame {
    ...
    private final String internalFrameName = "Item Transfer (Department wise)";

    /**
     * Creates new form ItemTransfer
     */
    public ItemTransferDepartmentWise() {
        initComponents();
        ...
        ImageIcon DefaultBackGround = new ImageIcon(projectPath + "/pictures/InternalFrameIcons/Transaction/transferDepartmentWise.png");
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("Item Transfer (Department wise)");
...
//    }
    private void LoadTakeFromToCombo() {
        try {
            ...
            if (rset.next()) {
                do {
                    cmbTakeFrom.insertItemAt(rset.getString("DepartmentName") + "--" + rset.getString("DepartmentCode"), position); // 
                    position++;
                } while (rset.next());
            }
    ...
    private void LoadSendToToCombo() {
        try {
            ...
            if (rset.next()) {
                do {
                    cmbTransferTo.insertItemAt(rset.getString("DepartmentName") + "--" + rset.getString("DepartmentCode"), position); // 
                    position++;
                } while (rset.next());
            }
    ...
    private void SaveAsTransfer(String Time, String Date) {
        String ItemCode, ItemName, PurchaseUnitCode, transferToDepartmentType, departmentType = "Stock", UnitSell;
        double PurchasePrice, Quantity, Amount, takeFromNewQuantity, transferToNewQuantity, PriceLevel = 0;
        double CurrentQuantity, NewQuantity = 0, takeFromCurrentQuantity, transferToCurrentQuantity, SellPrice;
        ResultSet RSETCurrentItemQuantity, RSETtransferToDepartment, RSETItemAlreadyAtTakeFromDepartment, RSETItemAlreadyAtTransferToDepartment;
        ...
        try {
            ...
            java.sql.Statement stmttransferToDepartment = ConnectSql.conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);

            java.sql.Statement stmtItemAlreadyAtTakeFromDepartment = ConnectSql.conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            java.sql.Statement stmtTakeFromStockUpdate = ConnectSql.conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            ...
            for (int i = 0; i < RowCount; i++) {
                ...
                String transferToDepartment = "SELECT Type FROM Departments WHERE DepartmentCode='" + TransferToCode[1] + "'";
                RSETtransferToDepartment = stmttransferToDepartment.executeQuery(transferToDepartment);

                String ItemAlreadyAtTakeFromDepartmentQuery = "SELECT Quantity FROM ItemsAtDepartments WHERE ItemCode='" + ItemCode + "' AND DepartmentCode ='" + TakeFromCode[1] + "'";
                RSETItemAlreadyAtTakeFromDepartment = stmtItemAlreadyAtTakeFromDepartment.executeQuery(ItemAlreadyAtTakeFromDepartmentQuery);

                if (RSETCurrentItemQuantity.next() && RSETtransferToDepartment.next()) {
                    transferToDepartmentType = RSETtransferToDepartment.getString("Type");
                    CurrentQuantity = RSETCurrentItemQuantity.getDouble("Quantity");

                    if (transferToDepartmentType.equals(departmentType)) {
                        ...
                        if (RSETItemAlreadyAtTakeFromDepartment.next()) {
                            takeFromCurrentQuantity = RSETItemAlreadyAtTakeFromDepartment.getDouble("Quantity");
                            takeFromNewQuantity = roundThreeDecimals(takeFromCurrentQuantity - Quantity);

                            String takeFromStockUpdateQuery = "Update ItemsAtDepartments set Quantity = '" + takeFromNewQuantity + "' where ItemCode='" + ItemCode + "' AND DepartmentCode ='" + TakeFromCode[1] + "'";
                            stmtTakeFromStockUpdate.execute(takeFromStockUpdateQuery);
                        }
                    } else {
                        java.sql.Statement stmtItemAlreadyAtTransferToDepartment = ConnectSql.conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);

                        String ItemAlreadyAtTransferToDepartmentQuery = "SELECT Quantity FROM ItemsAtDepartments WHERE ItemCode='" + ItemCode + "' AND DepartmentCode ='" + TransferToCode[1] + "'";
                        RSETItemAlreadyAtTransferToDepartment = stmtItemAlreadyAtTransferToDepartment.executeQuery(ItemAlreadyAtTransferToDepartmentQuery);

                        if (RSETItemAlreadyAtTakeFromDepartment.next() && RSETItemAlreadyAtTransferToDepartment.next()) {
                            takeFromCurrentQuantity = RSETItemAlreadyAtTakeFromDepartment.getDouble("Quantity");
                            transferToCurrentQuantity = RSETItemAlreadyAtTransferToDepartment.getDouble("Quantity");

                            takeFromNewQuantity = roundThreeDecimals(takeFromCurrentQuantity - Quantity);
                            transferToNewQuantity = roundThreeDecimals(transferToCurrentQuantity + Quantity);

                            java.sql.Statement stmtTransferToStockUpdate = ConnectSql.conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);

                            String takeFromStockUpdateQuery = "Update ItemsAtDepartments set Quantity = '" + takeFromNewQuantity + "' where ItemCode='" + ItemCode + "' AND DepartmentCode ='" + TakeFromCode[1] + "'";
                            stmtTakeFromStockUpdate.execute(takeFromStockUpdateQuery);

                            String transferToStockUpdateQuery = "Update ItemsAtDepartments set Quantity = '" + transferToNewQuantity + "' where ItemCode='" + ItemCode + "' AND DepartmentCode ='" + TransferToCode[1] + "'";
                            stmtTransferToStockUpdate.execute(transferToStockUpdateQuery);

                            stmtTakeFromStockUpdate.close();
                            stmtTransferToStockUpdate.close();
                        } else if (!RSETItemAlreadyAtTransferToDepartment.next()) {
...
//                            stmtItemsAtDepartmentsQty.close();
                        ...
                        stmtItemAlreadyAtTakeFromDepartment.close();
                        stmtItemAlreadyAtTransferToDepartment.close();
                    }
            ...
            stmttransferToDepartment.close();
    ...
    private void SearchItemByCode(String ItemCode) {
        try {
            ...
            int rowCount = 0;
            RefreshTable();
            String departmentCode[] = cmbTakeFrom.getSelectedItem().toString().split("--");

            if (!ItemCode.equals("")) {
                query = "SELECT DISTINCT\n"
                        + "     ItemsAtDepartments.\"ItemCode\" AS ItemsAtDepartments_ItemCode,\n"
                        + "     ItemsAtDepartments.\"DepartmentCode\" AS ItemsAtDepartments_DepartmentCode,\n"
                        + "     ItemsAtDepartments.\"SellPrice\" AS ItemsAtDepartments_SellPrice,\n"
                        + "     ItemsAtDepartments.\"Quantity\" AS ItemsAtDepartments_Quantity,\n"
                        + "     ItemsAtDepartments.\"UnitSell\" AS ItemsAtDepartments_UnitSell,\n"
                        ...
                        + "FROM\n"
                        + "     \"dbo\".\"Items\" Items INNER JOIN \"dbo\".\"ItemsAtDepartments\" ItemsAtDepartments ON Items.\"ItemCode\" = ItemsAtDepartments.\"ItemCode\"\n"
                        + " WHERE Visibility = 'Yes' AND ItemsAtDepartments.\"DepartmentCode\" = '" + departmentCode[1] + "' AND ItemsAtDepartments.\"ItemCode\" LIKE '" + ItemCode + "%'";
            } else {
                query = "SELECT DISTINCT\n"
                        + "     ItemsAtDepartments.\"ItemCode\" AS ItemsAtDepartments_ItemCode,\n"
                        + "     ItemsAtDepartments.\"DepartmentCode\" AS ItemsAtDepartments_DepartmentCode,\n"
            ...
            while (reset.next()) {
                model_AvailableItemTable.addRow(new Object[model_AvailableItemTable.getColumnCount()]);
                TableAvailableItem.setValueAt(reset.getString("ItemsAtDepartments_ItemCode"), rowCount, 0);
                TableAvailableItem.setValueAt(reset.getString("Items_ItemName"), rowCount, 1);
                TableAvailableItem.setValueAt(reset.getString("Items_UnitPurchase"), rowCount, 2);
                TableAvailableItem.setValueAt(reset.getFloat("Items_PurchasePrice"), rowCount, 3);
                TableAvailableItem.setValueAt(reset.getFloat("ItemsAtDepartments_Quantity"), rowCount, 4);
                TableAvailableItem.setValueAt(reset.getString("Items_SubCategoryCode"), rowCount, 5);
                TableAvailableItem.setValueAt(reset.getString("Items_SupplierCode"), rowCount, 6);
                rowCount++;
            }
            reset.close();
        ...
        try {
            ...
            if (!ItemName.equals("")) {
                query = "SELECT DISTINCT\n"
                        ...
                        + "FROM\n"
                        + "     \"dbo\".\"Items\" Items INNER JOIN \"dbo\".\"ItemsAtDepartments\" ItemsAtDepartments ON Items.\"ItemCode\" = ItemsAtDepartments.\"ItemCode\"\n"
                        + " WHERE Visibility = 'Yes' AND ItemsAtDepartments.\"DepartmentCode\" = '" + departmentCode[1] + "' AND Items.\"ItemName\" LIKE '" + ItemName + "%'";
            } else {
                query = "SELECT DISTINCT\n"
                        + "     ItemsAtDepartments.\"ItemCode\" AS ItemsAtDepartments_ItemCode,\n"
                        + "     ItemsAtDepartments.\"DepartmentCode\" AS ItemsAtDepartments_DepartmentCode,\n"
    ...
    private void CheckAtUpdateButtonBeforeUpdate() {
        if (!TextPurchasePrice.getText().equals("") && !TextQuantity.getText().equals("") && !TextAmount.getText().equals("")) {
            ...
            try {
                ...
                Logger.getLogger(ItemTransferDepartmentWise.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                JOptionPane.showMessageDialog(this, "Please contact for support.");
            }
        ...
        if (!TextPurchasePrice.getText().equals("") && !TextQuantity.getText().equals("") && !TextAmount.getText().equals("")) {
            ...
            if (TransferQuantity > 0) {
                try {
                    ...
                    ResultSet RSETAvaItems;
                    java.sql.Statement stmtGRNItems = ConnectSql.conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
                    String ItemQuery = "SELECT Quantity FROM ItemsAtDepartments WHERE ItemCode='" + ItemCode + "'";
